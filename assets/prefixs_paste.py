...
if prefix == 0xD2: # SET 2,D     | ---- | 2 8
    cycles(8)
if prefix == 0xD4: # SET 2,E     | ---- | 2 8
    cycles(8)
if prefix == 0xD5: # SET 2,H     | ---- | 2 8
    cycles(8)
if prefix == 0xD6: # SET 2,L     | ---- | 2 8
    cycles(8)
if prefix == 0xD7: # SET 2,(HL)  | ---- | 2 16
    cycles(16)
if prefix == 0xD8: # SET 2,A     | ---- | 2 8
    cycles(8)
if prefix == 0xD9: # SET 3,B     | ---- | 2 8
    cycles(8)
if prefix == 0xDA: # SET 3,C     | ---- | 2 8
    cycles(8)
if prefix == 0xDC: # SET 3,D     | ---- | 2 8
    cycles(8)
if prefix == 0xDE: # SET 3,E     | ---- | 2 8
    cycles(8)
if prefix == 0xDF: # SET 3,H     | ---- | 2 8
    cycles(8)
if prefix == 0xE0: # SET 3,L     | ---- | 2 8
    cycles(8)
if prefix == 0xE1: # SET 3,(HL)  | ---- | 2 16
    cycles(16)
if prefix == 0xE2: # SET 3,A     | ---- | 2 8
    cycles(8)
if prefix == 0xE5: # SET 4,B     | ---- | 2 8
    cycles(8)
if prefix == 0xE6: # SET 4,C     | ---- | 2 8
    cycles(8)
if prefix == 0xE7: # SET 4,D     | ---- | 2 8
    cycles(8)
if prefix == 0xE8: # SET 4,E     | ---- | 2 8
    cycles(8)
if prefix == 0xE9: # SET 4,H     | ---- | 2 8
    cycles(8)
if prefix == 0xEA: # SET 4,L     | ---- | 2 8
    cycles(8)
if prefix == 0xEE: # SET 4,(HL)  | ---- | 2 16
    cycles(16)
if prefix == 0xEF: # SET 4,A     | ---- | 2 8
    cycles(8)
if prefix == 0xF0: # SET 5,B     | ---- | 2 8
    cycles(8)
if prefix == 0xF1: # SET 5,C     | ---- | 2 8
    cycles(8)
if prefix == 0xF2: # SET 5,D     | ---- | 2 8
    cycles(8)
if prefix == 0xF3: # SET 5,E     | ---- | 2 8
    cycles(8)
if prefix == 0xF5: # SET 5,H     | ---- | 2 8
    cycles(8)
if prefix == 0xF6: # SET 5,L     | ---- | 2 8
    cycles(8)
if prefix == 0xF7: # SET 5,(HL)  | ---- | 2 16
    cycles(16)
if prefix == 0xF8: # SET 5,A     | ---- | 2 8
    cycles(8)
if prefix == 0xF9: # SET 6,B     | ---- | 2 8
    cycles(8)
if prefix == 0xFA: # SET 6,C     | ---- | 2 8
    cycles(8)
if prefix == 0xFB: # SET 6,D     | ---- | 2 8
    cycles(8)
if prefix == 0xFE: # SET 6,E     | ---- | 2 8
    cycles(8)
if prefix == 0xFF: # SET 6,H     | ---- | 2 8
    cycles(8)
